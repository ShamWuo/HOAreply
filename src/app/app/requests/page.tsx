  ...
  return (
    <div className="space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-slate-600">System of record: everything that has happened or is happening. Inbox is your work queue; use Requests for history and audit.</p>
