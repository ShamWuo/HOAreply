      ...
      <GlassPanel className="p-6 space-y-4">
        ...
        {hoas.length === 0 ? (
          <div className="rounded-lg border border-dashed border-[var(--color-border)] bg-white/70 p-10 text-center text-sm text-[var(--color-muted)]">
            <p className="mb-4">No HOAs yet. Create an HOA inbox to unlock Gmail sync and routing.</p>
            <div className="mx-auto max-w-md"><CreateHoaForm /></div>
          </div>
        ) : (
          <div className="space-y-3">
            <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 text-xs text-[var(--color-muted)]">
              One HOA inbox per workspace is supported today. Contact support to add more.
            </div>
